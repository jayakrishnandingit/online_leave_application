...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'LeaveBucket'
        db.create_table(u'leave_leavebucket', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('subscriber', self.gf('django.db.models.fields.related.ForeignKey')(related_name='subscriber_leave_bucket_subscriber', to=orm['subscriber.Subscriber'])),
            ('type_of_leave', self.gf('django.db.models.fields.related.ForeignKey')(related_name='subscriber_leave_bucket_type', to=orm['leave.LeaveType'])),
            ('bucket', self.gf('django.db.models.fields.FloatField')()),
            ('created_on', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('created_by', self.gf('django.db.models.fields.related.ForeignKey')(related_name='subscriber_leave_bucket_created_by', to=orm['subscriber.Subscriber'])),
            ('updated_on', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
        ))
        db.send_create_signal(u'leave', ['LeaveBucket'])


    def backwards(self, orm):
        # Deleting model 'LeaveBucket'
        db.delete_table(u'leave_leavebucket')
