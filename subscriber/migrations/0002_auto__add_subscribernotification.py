...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'SubscriberNotification'
        db.create_table(u'subscriber_subscribernotification', (
        ...
        db.send_create_signal(u'subscriber', ['SubscriberNotification'])


    def backwards(self, orm):
        # Deleting model 'SubscriberNotification'
        db.delete_table(u'subscriber_subscribernotification')
    ...
    models = {
        ...
        u'subscriber.subscribernotification': {
            'Meta': {'object_name': 'SubscriberNotification'},
            'action': ('django.db.models.fields.IntegerField', [], {}),
            'actor': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'notification_actor'", 'to': u"orm['subscriber.Subscriber']"}),
            'created_on': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'has_read': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'recipient': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'notification_recipient'", 'to': u"orm['subscriber.Subscriber']"}),
