...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'subscriber_subscriber', (
            ...
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='subscriber_user', to=orm['auth.User'])),
            ('client', self.gf('django.db.models.fields.related.ForeignKey')(related_name='subscriber_client', to=orm['client.Client'])),
